...
def q_tree(arr, start, end):
    if color_check(arr, start, end) == False:
        ...
        if end[0] - start[0] == 1:
            ...
            ft_end = end
            print('(', end='')
            q_tree(arr, f_start, f_end)
            q_tree(arr, s_start, s_end)
            q_tree(arr, t_start, t_end)
            q_tree(arr, ft_start, ft_end)
            print(')', end='')
    else:
...
# start = [0,0]
# end = [1,1]
# print(color_check(arr, start, end)) 